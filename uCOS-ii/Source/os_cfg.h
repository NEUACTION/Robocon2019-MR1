...
#define OS_CFG_H
                                       ...
                                       /* ---------------------- MY SETING ----------------------- */
#define DEF_ON                    1u   /* ***********************BOOL*******************************/
#define DEF_OFF                   0u   /* ***********************BOOL*******************************/  

#define DEF_TRUE                  1u   /* ***********************BOOL*******************************/  
#define DEF_FALSE                 0u   /* ***********************BOOL*******************************/ 
...
#define OS_MAX_EVENTS            60u   /* Max. number of event control blocks in your application      */
